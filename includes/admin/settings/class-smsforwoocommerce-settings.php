...
class Settings {
	...
	public function get_settings() {
		...
		if ( ! $settings ) {
			update_option( $this->setting_name, array(
                            'gateway_wpsmstowoo_sender_id' => 'SMSto',
	...
	public function get_registered_settings() {
		...
		$settings = apply_filters( 'sms_to_woo_registered_settings', array(
			...
			'general'       => apply_filters( 'sms_to_woo_general_settings', array(
				...
				'admin_title_wpsmstowoo_privacy' => array(
					'id'   => 'admin_title_wpsmstowoo_privacy',
					'name' => __( 'Privacy', 'sms-for-woocommerce' ),
					'type' => 'header'
				),
				'gdpr_wpsmstowoo_compliance'     => array(
					'id'      => 'gdpr_wpsmstowoo_compliance',
					'name'    => __( 'GDPR Enhancements', 'sms-for-woocommerce' ),
					'type'    => 'checkbox',
					'options' => $options,
					'desc'    => __( 'Enable GDPR related features in this page. Read our GDPR documentation to learn more.', 'sms-for-woocommerce' ),
				),
			) ),
			...
			'gateway'       => apply_filters( 'sms_to_woo_gateway_settings', array(
				...
				'gateway_wpsmstowoo_api_key'          => array(
					...
					'desc' => __( 'Enter Api Key', 'sms-for-woocommerce' )
                                ...
                                'gateway_wpsmstowoo_callback_url'          => array(
					'id'   => 'gateway_wpsmstowoo_callback_url',
					'name' => __( 'Callback URL', 'sms-for-woocommerce' ),
					'type' => 'text',
					'desc' => __( 'Your WordPress callback URL to update Reports<br>If you must change it, please do it with caution', 'sms-for-woocommerce' )
				),                                                        
            ...
            <div class="wpsmstowoo-tab-group">
                <ul class="wpsmstowoo-tab">
                    <li id="wpsmstowoo-logo" class="wpsmstowoo-logo-group">
                        <img src="<?php echo SFW_SMS_TO_WOO_URL; ?>assets/images/intergo-telecom-logo.png"/>
                        <p><?php echo sprintf( __( 'SMS for WooCommerce - by SMS.to v%s', 'sms-for-woocommerce' ), SFW_SMS_TO_WOO_VERSION ); ?></p>
